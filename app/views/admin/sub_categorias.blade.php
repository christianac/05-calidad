                                ...
                                <ul class="nav nav-tabs">
                                  <li class="active">
                                    <a href="#product" data-toggle="tab">
                                      ...
                                      <span>Registrar Sub-Categorias</span>
                                    </a>
                                  </li>
                                  <li>
                                    <a href="#return" data-toggle="tab">
                                      <i class="icon-reorder"></i>
                                      <span>Listar Sub-Categorias</span>
                                    </a>
                                  </li>
                                </ul>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$sub_categoria->cod_sub_categoria}}</td>
                                                <td>Categoria relacionar</td>
                                                <td>{{$sub_categoria->subcategoria}}</td>
                                                <td>{{$sub_categoria->imagen}}</td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
